...
export default function ArcViewer({
  ...
  return (
    <>
      ...
      <iframe
        src={`https://allpoland.github.io/ArcViewer/?scoreID=${props.playingSong.id}
        `}
        referrerPolicy="no-referrer"
        className="w-full h-full opacity-100"
      />
      <div
        className={`flex justify-center items-center w-1/3 h-1/6 absolute top-0 left-0 bg-white rounded-lg ${
      ...
      {/* <div
        className={`flex justify-center items-center w-2/3 h-24 absolute bottom-0 bg-white rounded-lg ${
          randomTimeMode && !props.reveal ? "" : "hidden"
        }`}
      >
        <p className="text-3xl text-black font-bold cursor-default">? ? ? ?</p>
      </div> */}
      <div
        className={`flex flex-col gap-2 justify-center items-center w-1/6 h-1/3 bottom-1/2 rounded-lg absolute left-0 bg-white ${
          props.reveal ? "hidden" : ""
        }`}
      >
        <p className="text-4xl text-black font-bold cursor-default">? ? ? ?</p>
        <div className="flex flex-col justify-center items-center">
          <p className="text-xl text-black font-bold cursor-default">
            First Person / Third Person
          </p>
          <p className="text-4xl text-black font-bold cursor-default">
            &quot;F&quot;
          </p>
        </div>
      </div>

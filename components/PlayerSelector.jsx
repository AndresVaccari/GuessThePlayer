...
export default function PlayerSelector({
  ...
  const searchEndpoint = (query) =>
    `https://cors-anywhere.herokuapp.com/https://api.beatleader.xyz/players?sortBy=pp&page=1&count=50&search=${query}&mapsType=ranked&ppType=general&friends=false`;
